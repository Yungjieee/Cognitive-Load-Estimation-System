...
export const PENALTY_HINT_PER_USE = 1;            // points per hint
export const PENALTY_EXTRA_TIME_TOTAL = 2;        // total-score penalty
export const EXTRA_TIME_FACTOR = 0.30;            // +30% of original limit
export const REST_MIN_MS = 60_000;                // 60s
export const REST_MAX_MS = 120_000;               // 120s
export const TEN_SECOND_WARNING_AT = 10;          // seconds left
export const STRESSOR_SHOW_WINDOW = [0.25, 0.50]; // as % of limit
export const MOCK_HR_BASE = 75;                   // bpm
export const MOCK_HR_NOISE = 8;                   // ±

// Difficulty schedule configuration
...
export const TOTAL_POINTS = DIFFICULTY_SCHEDULE.reduce((sum, q) => sum + q.points, 0); // 100
